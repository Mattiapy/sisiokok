        ...
        do{
            ...
            switch(ris){
                case 1:{//INSERISCI DIPENDENTI
                    ...
                    switch(ris1){
                        ...
                        case 2:{
                            ...
                            String cognome = Read.string("Inserisci cognome dell'impiegato:");
                            int oreMensili = Read.integer("Inserisci le ore mensili dell'impiegato");
                            g.aggiungiDipendente(new Manager(nome, cognome, oreMensili, g));
                            break;
                        }
                    }
                    break;
                ...
                case 2:{//RIMUOVI DIPENDENTI
                    if(g.getDipendentiSize() == 0){
                        System.out.println("Non ci sono dipendenti da rimuovere");
                        break;
                    }
                    g.stampaDipendenti();
                ...
                case 4:{//RIMUOVI ACQUISTI
                    if(g.getAcquistiSize()== 0){
                        System.out.println("Non ci sono acquisti da rimuovere");
                        break;
                    }
                    g.stampaAcquisti();
                ...
                switch (tipo) {
                    ...
                    if(g.getVenditeSize()== 0){
                        System.out.println("Non ci sono vendite da rimuovere");
                        break;
                    }
                    g.stampaAcquisti();
                    System.out.println("Inserisci l'indice della vendita da rimuovere");
